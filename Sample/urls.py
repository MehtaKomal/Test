...
urlpatterns = [
    ...
    url(r'^recent_activity_student/(?P<student_id>\d+)/$', recent_activity_student,
                      name='recent_activity_student'),
    url(r'^coreHike/show_expert_profile_by_student/(?P<expert_id>\d+)/$', show_expert_profile_by_student,
                      name='show_expert_profile'),
    url(r'^send_activity_request/(?P<activity_id>\d+)/(?P<student_id>\d+)/(?P<expert_id>\d+)$', send_activity_request,
